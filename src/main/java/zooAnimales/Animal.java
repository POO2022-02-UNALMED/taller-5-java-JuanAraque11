...
public class Animal {
	...
	public String toString() {
		if(zona != null) {
			return "Mi nombre es" + nombre + "tengo una edad de" + edad + "habito en"+ habitat + "y mi genero es" + genero + "la zona en la que me ubico es"+ Zona.getNombre() + "en el"+ Zoologico.getNombre()  ;
		}
		else {
